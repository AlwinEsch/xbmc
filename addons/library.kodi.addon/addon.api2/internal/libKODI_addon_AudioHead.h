...
namespace V2
{
  ...
  typedef void _soundplay_play(void* HANDLE, IAESound* sndHandle);
  ...
  typedef void _soundplay_set_channel(void* HANDLE, IAESound* sndHandle, audio_channel_t channel);
  typedef audio_channel_t _soundplay_get_channel(void* HANDLE, IAESound* sndHandle);
