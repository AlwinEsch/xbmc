...
namespace V2
{
  ...
  public:
    ...
    {
      if (iCodecType == KODI_CODEC_TYPE_VIDEO)
        return true;
      else if (other.iCodecType != KODI_CODEC_TYPE_VIDEO)
    ...
    void Clear()
    {
      ...
      iCodecType = KODI_CODEC_TYPE_UNKNOWN;
    }
  ...
  public:
    ...
    void UpdateStreams(stream_vector &newStreams)
    {
      ...
      if (newStreams.size() > PVR_STREAM_MAX_STREAMS)
      {
        ...
        CAddOnLib_General::Log(AddOnLIB::V2::LOG_ERROR, "%s - max amount of streams reached", __FUNCTION__);
      }
