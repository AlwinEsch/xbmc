 ...
 */
  ...
  #include "kodi/AudioEngine/kodi_adsp_types.h"
  ...
  #include "addons/library.kodi.addon/addon.api2/AddonLib.h"
#endif
...
#define IMPLEMENT_ADDON_AE_STREAM                                              \
  ...
  typedef const unsigned int      _Stream_GetEncodedSampleRate(void *addonData, AEStreamHandle *handle);
  ...
  typedef bool                    _Stream_SetResampleRatio(void *addonData, AEStreamHandle *handle, double Ratio);
  typedef void                    _Stream_Discontinuity(void *addonData, AEStreamHandle *handle);
  ...
  typedef struct CB_AudioEngineLib_Stream
  {
    ...
    _Stream_GetEncodedSampleRate*   AEStream_GetEncodedSampleRate;
    ...
    _Stream_Discontinuity*          AEStream_Discontinuity;
