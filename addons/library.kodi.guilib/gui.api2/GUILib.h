...
//       dlsym(m_libKODI_guilib, "GUILIB_V2_register");
//     if (GUI_register_me == NULL) { fprintf(stderr, "Unable to assign function %s\n", dlerror()); return false; }
//
//     GUI_register_level = (void* (*)(void *HANDLE, int level))
//       dlsym(m_libKODI_guilib, "GUILIB_V2_register_level");
//     if (GUI_register_level == NULL) { fprintf(stderr, "Unable to assign function %s\n", dlerror()); return false; }
//
//     GUI_unregister_me = (void (*)(void *HANDLE, void *CB))
//       dlsym(m_libKODI_guilib, "GUILIB_V2_unregister_me");
...
//
//     m_Callbacks = GUI_register_level(m_Handle, 2);
...
//   void* (*GUI_register_level)(void *HANDLE, int level);
