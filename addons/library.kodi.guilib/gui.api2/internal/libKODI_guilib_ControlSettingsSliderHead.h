...
namespace V2
{
  ...
  typedef void GUIControl_SettingsSlider_SetLabel
      (void         *addonData,
       GUIHANDLE     handle,
       const char   *label);

  typedef void GUIControl_SettingsSlider_GetDescription
      (void         *addonData,
       GUIHANDLE     handle,
       char         &text,
  ...
  typedef struct CB_GUILib_Control_SettingsSlider
  {
    ...
    GUIControl_SettingsSlider_SetLabel*                  SetLabel;
    GUIControl_SettingsSlider_GetDescription*            GetDescription;
