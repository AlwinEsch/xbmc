...
namespace V2
{
          ...
          std::string&            strNewPassword)
  {
    ...
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndVerifyNewPassword(strNewPassword[0], size);
          ...
          int                     iRetries)
  {
    ...
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndVerifyPassword(strPassword[0], size, strHeading.c_str(), iRetries);
          ...
          bool                    bGetUserInput)
  {
    strPassword.resize(1024);
    unsigned int size = (unsigned int)strPassword.capacity();
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndVerifyInput(strPassword[0], size, strHeading.c_str(), bGetUserInput);
    strPassword.resize(size);
    strPassword.shrink_to_fit();
    return ret;
  }
  ...
  inline bool CAddonGUIDialogNumeric::ShowAndGetTime(
          ...
          const std::string&      strHeading)
  {
    return CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndGetTime(time, strHeading.c_str());
  }
  ...
  inline bool CAddonGUIDialogNumeric::ShowAndGetDate(
          ...
          const std::string&      strHeading)
  {
    return CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndGetDate(date, strHeading.c_str());
  }
          ...
          const std::string&      strHeading)
  {
    ...
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndGetIPAddress(strIPAddress[0], size, strHeading.c_str());
          ...
          unsigned int            iAutoCloseTimeoutMs)
  {
    ...
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndGetNumber(strInput[0], size, strHeading.c_str(), iAutoCloseTimeoutMs);
          ...
          const std::string&      strHeading)
  {
    ...
    bool ret = CGUILib::g_libKODI_Internal->Dialogs.Numeric.ShowAndGetSeconds(strTime[0], size, strHeading.c_str());
    strTime.resize(size);
