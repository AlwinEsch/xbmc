...
namespace V2
{
  ...
  {
    CGUILib::g_libKODI_Internal->Dialogs.OK.ShowAndGetInputSingleText(heading.c_str(), text.c_str());
  }
  ...
  {
    CGUILib::g_libKODI_Internal->Dialogs.OK.ShowAndGetInputLineText(heading.c_str(), line0.c_str(), line1.c_str(), line2.c_str());
  }
