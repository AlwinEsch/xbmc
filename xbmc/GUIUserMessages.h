...
//@{
#define GUI_MSG_WEB_ADDON_READY \
  GUI_MSG_USER + \
      50 // Sent to tell that web addon control is ready and related processes can be done
#define GUI_MSG_WEB_CONTROL_REOPEN \
  GUI_MSG_USER + 51 // Sent to tell that control is already open and was only inactive
#define GUI_MSG_WEB_UPDATE_ADDRESS \
  GUI_MSG_USER + 52 // Sent to change on URL entry field the active string
