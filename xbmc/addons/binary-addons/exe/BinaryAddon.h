...
#include "addons/kodi-addon-dev-kit/include/kodi/exe/definitions.h"
#include "tools.h"
/*
...
//      private V2::KodiAPI::CAddonExeCB_PVR_Trigger
  ...
  private:
    ...
    *
    * @param[in] req           Stream Tx traffic class (CRequestPacket)
    ...
    *   | @param[in] API_BOOL   | m_isIndependent   | To become informed that add-on is independent  |
    ...
    * @param[out] resp         Stream Tx traffic class (CResponsePacket)
    ...
    *   | @param[out] API_BOOL  | sharedMemOK       | To inform add-on about available shared memory |
