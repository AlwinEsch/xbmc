...
bool CBinaryAddonSharedMemoryPosix::CreateSharedMemory()
{
  ...
  if ((m_sharedMem_AddonToKodi = (apiShareData*)shmat(m_shmId_FromAddonToKodi, NULL, 0)) == (apiShareData *) -1)
  {
  ...
  if ((m_sharedMem_KodiToAddon = (apiShareData*)shmat(m_shmId_FromKodiToAddon, NULL, 0)) == (apiShareData*) -1)
  {
