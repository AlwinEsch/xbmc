...
bool CBinaryAddonSharedMemory::CreateSharedMemory()
{
  ...
  m_sharedMem_AddonToKodi = (apiShareData*)MapViewOfFile(m_handle_AddonToKodi, FILE_MAP_ALL_ACCESS, 0, 0, 0);
  ...
  m_sharedMem_KodiToAddon = (apiShareData*)MapViewOfFile(m_handle_KodiToAddon, FILE_MAP_ALL_ACCESS, 0, 0, 0);
