...
public:
  ...
  static audio_channel_t soundplay_get_channel(
      void*                     hdl,
      IAESound*                 sndHandle);
...
private:
  static enum AEChannel GetKODIChannel(audio_channel_t channel);
  static audio_channel_t GetAddonChannel(enum AEChannel channel);
};
