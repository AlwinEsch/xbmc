...
#define XBMC_AE_DSP_API_VERSION                 "0.1.5"

/* min. Audio DSP API version */
#define XBMC_AE_DSP_MIN_API_VERSION             "0.1.5"
...
//@{
  ...
  typedef struct AE_DSP_PROFILE_AC3_EAC3
  {
    ...
    float        fMixLevelCenter;               /*!< Center mix level */
    float        fMixLevelCenterLtRt;           /*!< Center mix level for Lt/Rt */
    float        fMixLevelSurround;             /*!< Surround mix level */
    float        fMixLevelSurroundLtRt;         /*!< Surround mix level for Lt/Rt */
    float        fMixLevelLFE;                  /*!< LFE mix level */
