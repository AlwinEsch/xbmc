...
public:
   ...
   */
  static bool Ping();
  static void addon_log_msg(void* kodiBase, const int loglevel, const char* msg);
  int
        (__cdecl* InitThread)
              ();
...
private:
  ...
  static void Log_Console(const int loglevel, const char* text);
...
class ATTRIBUTE_HIDDEN CMain
  : public kodi::addon::CAddonBase,
    public CKODIAddon_InterProcess
{
public:
  CMain();

  static CMain m_interProcess;
  static std::unordered_map<std::thread::id, CKODIAddon_InterProcess*> m_threadMap;
