...
//   typedef void* KODI_INSTANCE_HDL;
  ...
  typedef enum ADDON_STATUS(ATTR_APIENTRYP PFN_KODI_ADDON_SETTING_CHANGE_FLOAT_V1)(const KODI_ADDON_HDL hdl,
                                                                                const char* name,
                                                                                float value);
  typedef enum ADDON_STATUS(ATTR_APIENTRYP PFN_KODI_ADDON_SETTING_CHANGE_FLOAT2_V2)(const KODI_ADDON_HDL hdl,
                                                                                const char* name,
                                                                                float value);
...
#if __KODI_API__ >= 2
    PFN_KODI_ADDON_SETTING_CHANGE_FLOAT2_V2 setting_change_float2;
#endif /* !__KODI_API__ >= 2 */
