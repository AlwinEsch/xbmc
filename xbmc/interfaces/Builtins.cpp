...
const BUILT_IN commands[] = {
  ...
  { "CancelCut",                  false,  "Stops the recording cut" },
...
//        g_application.m_pPlayer->SceneMarker_Toggle();
  ...
  else if (execute == "notification")
  {
    ...
    if (params.size() == 4)
      ...
      CGUIDialogKaiToast::QueueNotification((CGUIDialogKaiToast::eMessageType)atoi(params[0].c_str()), params[1], params[2], atoi(params[3].c_str()) == 0 ? TOAST_DISPLAY_TIME : atoi(params[3].c_str()), atoi(params[4].c_str()));
    else
